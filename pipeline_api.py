# pipeline_api.py
"""
Media + Text Summarizer Backend
Supports:
 - audio → Whisper → Pegasus + BART summarizer
 - video → Whisper → Pegasus + BART summarizer
 - text (.txt, .md) → Pegasus + BART summarizer (NO Whisper)

POST /api/analyze
Form fields:
 file, mediaType (audio|video|text), summaryLength, extractActions, language
"""
